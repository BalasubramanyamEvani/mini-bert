...
class BertSentClassifier(torch.nn.Module):
    def __init__(self, config):
        ...
        self.out_dropout_layer = torch.nn.Dropout(config.hidden_dropout_prob)
        self.out_dense_layer = torch.nn.Linear(config.hidden_size, self.num_labels)
    ...
    def forward(self, input_ids, attention_mask):
        ...
        output = self.out_dense_layer(output)
